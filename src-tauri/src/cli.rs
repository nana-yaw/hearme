...
#[command(name = "handy", about = "HearMe - Speech to Text")]
pub struct CliArgs {
    ...
    /// Apply the RNNoise noise-suppression pass to --transcribe-file input
    /// before transcription (mirrors the noise_suppression_enabled setting).
    #[arg(long)]
    pub denoise: bool,
