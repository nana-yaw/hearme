...
async changeLiveTypingSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_live_typing_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async getFrontmostAppBundleId() : Promise<string | null> {
    return await TAURI_INVOKE("get_frontmost_app_bundle_id");
},
async changeAppProfilesSetting(profiles: AppProfile[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_app_profiles_setting", { profiles }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async loadModelManually() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("load_model_manually") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async benchmarkStartRecording() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("benchmark_start_recording") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async benchmarkStopRecording(phraseIndex: number) : Promise<Result<BenchmarkRecordingResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("benchmark_stop_recording", { phraseIndex }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async benchmarkCancelRecording() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("benchmark_cancel_recording") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async benchmarkDiscardSamples() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("benchmark_discard_samples") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runModelBenchmark(modelIds: string[], references: string[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("run_model_benchmark", { modelIds, references }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async cancelModelBenchmark() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("cancel_model_benchmark") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async searchHistoryEntries(query: string, limit: number | null) : Promise<Result<PaginatedHistory, string>> {
    try {
...
async getDictionarySuggestions() : Promise<Result<string[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("get_dictionary_suggestions") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type AppProfile = { bundle_id: string; prompt_id: string }
export type BenchmarkModelResult = { model_id: string; model_name: string; accuracy: number; speed_factor: number; load_ms: number; transcripts: string[]; error: string | null }
export type BenchmarkRecordingResult = { duration_secs: number; level_dbfs: number | null; too_quiet: boolean }
