...
import { type AppProfile, commands } from "@/bindings";
...
const settingUpdaters: {
  ...
  live_typing_enabled: (value) =>
    commands.changeLiveTypingSetting(value as boolean),
  accent_color: (value) => commands.changeAccentColorSetting(value as string),
  app_profiles: (value) =>
    commands.changeAppProfilesSetting(value as AppProfile[]),
